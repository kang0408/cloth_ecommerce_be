...
import * as controller from "../../controllers/wishlists.controller";
 ...
 */
router.get("", middleware.auth(["user", "admin"]), catchAsync(controller.getAll));
 ...
 *         description: Internal server error.
 */
router.post("/add/:id", middleware.auth(["user", "admin"]), catchAsync(controller.add));
