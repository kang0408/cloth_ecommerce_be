...
import * as controller from "../../controllers/otps.controller";
import * as otpValidate from "../../validations/otps.validation";
 ...
 */
router.post("/send-otp", otpValidate.sendOtp, catchAsync(controller.sendOtp));
 ...
 *         description: Internal server error.
 */
router.post("/verify-otp", otpValidate.verifyOtp, catchAsync(controller.verifyOtp));
